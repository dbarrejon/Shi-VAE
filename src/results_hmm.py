...
args.experiment = "results_hmm_paper"
args.ckpt_dir = "paper"
args.data_dir = "../data"
args.dataset = "hmm_heter_1000_1real_1pos_1bin_1cat_3_100"
args.n_epochs = 100
args.z_dim = 2
args.K = 3
args.plot_every = 10
...
n_masks = 10
miss_percent = [10, 30, 50]  # % missing
for miss_i in miss_percent:

    for mask_i in range(n_masks):
        mask_i = mask_i + 1

        # Shi-VAE
        args.model_name = '{}_{}_{}z_{}h_{}s_{}miss_{}'.format(args.model, args.dataset, args.z_dim,
                                                                   args.h_dim, args.K, miss_i, mask_i)
        ...
        # ============= LOAD DATA ============= #
        percent_miss = args.percent_miss
        X, Z, theta, mask, index = dset.load_data_pickle(args.dataset, args.data_dir,
                                                            percent_miss=miss_i, mask_i=mask_i)
